...
class TimeLineTileLeftChild extends StatelessWidget {
  final String status;
  ...
  Widget build(BuildContext context) {
    return MyTimelineTile(
      ...
      isFirst: isFirst,
      isLast: isLast,
      bottomLineStyle: LineStyle(width: 3, color: appBarBGcolor),
      indicatorStyle: IndicatorStyle(
        width: 15,
        color: colorDot != null ? colorDot : Colors.purple,
        indicatorY: 0.2,
...
class TimeLineTileRightChild extends StatelessWidget {
  final String status;
  final String comment;
  final String pathPhoto;
  final double indicatorY;
  ...
  Widget build(BuildContext context) {
    return TimelineTile(
      ...
      indicatorStyle: IndicatorStyle(
        ...
        color: colorDot != null ? colorDot : Colors.purple,
        indicatorY: 0.05,
        // indicatorY: indicatorY != null ? indicatorY : 0.2,
        padding: EdgeInsets.all(8),
      ),
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        final defaultChild = Container(height: 10);
